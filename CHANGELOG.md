...
- Expects a Codex CLI/app-server install that supports `codex app-server --listen stdio://` and the app-server methods used by the committed protocol snapshot and gateway client.
